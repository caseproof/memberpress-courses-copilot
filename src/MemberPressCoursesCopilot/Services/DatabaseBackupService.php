...
class DatabaseBackupService extends BaseService
{
     ...
     * Clean up old backups
     * 
     * @param int $older_than_days Delete backups older than this many days
     * @param int $keep_minimum Minimum number of backups to keep
     * @param bool $dry_run Preview without deleting
