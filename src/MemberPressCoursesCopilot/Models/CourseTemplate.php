...
class CourseTemplate
{
    ...
    private static function getTechnicalTemplate(): array
    {
        return [
            'default_structure' => [
                'sections' => [
                    ['title' => 'Introduction and Setup', 'lessons' => 3],
                    ['title' => 'Core Concepts', 'lessons' => 5],
                    ['title' => 'Implementation', 'lessons' => 6],
                    ['title' => 'Best Practices', 'lessons' => 4],
                    ['title' => 'Advanced Topics', 'lessons' => 4],
                    ['title' => 'Real-world Projects', 'lessons' => 3]
                ]
            ],
            'suggested_questions' => [
            ...
            'learning_progression' => [
                'beginner' => ['duration_weeks' => 4, 'focus' => 'Fundamentals'],
                'intermediate' => ['duration_weeks' => 6, 'focus' => 'Application'],
                'advanced' => ['duration_weeks' => 4, 'focus' => 'Optimization']
            ]
        ];
    }
    ...
    private static function getBusinessTemplate(): array
    {
        return [
            'default_structure' => [
                'sections' => [
                    ['title' => 'Course Overview and Objectives', 'lessons' => 2],
                    ['title' => 'Foundational Concepts', 'lessons' => 4],
                    ['title' => 'Strategic Planning', 'lessons' => 5],
                    ['title' => 'Implementation Strategies', 'lessons' => 6],
                    ['title' => 'Case Studies', 'lessons' => 4],
                    ['title' => 'Measuring Success', 'lessons' => 3]
                ]
            ],
            'suggested_questions' => [
            ...
            'learning_progression' => [
                'foundational' => ['duration_weeks' => 3, 'focus' => 'Core Concepts'],
                'practical' => ['duration_weeks' => 5, 'focus' => 'Application'],
                'strategic' => ['duration_weeks' => 4, 'focus' => 'Leadership']
            ]
        ];
    }
    ...
    private static function getCreativeTemplate(): array
    {
        return [
            'default_structure' => [
                'sections' => [
                    ['title' => 'Creative Foundation', 'lessons' => 3],
                    ['title' => 'Tools and Techniques', 'lessons' => 4],
                    ['title' => 'Creative Process', 'lessons' => 5],
                    ['title' => 'Style Development', 'lessons' => 4],
                    ['title' => 'Portfolio Building', 'lessons' => 3],
                    ['title' => 'Sharing Your Work', 'lessons' => 2]
                ]
            ],
            'suggested_questions' => [
            ...
            'learning_progression' => [
                'exploration' => ['duration_weeks' => 3, 'focus' => 'Discovery'],
                'development' => ['duration_weeks' => 5, 'focus' => 'Skill Building'],
                'mastery' => ['duration_weeks' => 4, 'focus' => 'Personal Style']
            ]
        ];
    }
    ...
    private static function getAcademicTemplate(): array
    {
        return [
            'default_structure' => [
                'sections' => [
                    ['title' => 'Course Introduction', 'lessons' => 2],
                    ['title' => 'Theoretical Foundations', 'lessons' => 5],
                    ['title' => 'Literature Review', 'lessons' => 4],
                    ['title' => 'Research Methods', 'lessons' => 5],
                    ['title' => 'Critical Analysis', 'lessons' => 5],
                    ['title' => 'Synthesis and Conclusions', 'lessons' => 3]
                ]
            ],
            'suggested_questions' => [
            ...
            'learning_progression' => [
                'foundational' => ['duration_weeks' => 4, 'focus' => 'Theory'],
                'analytical' => ['duration_weeks' => 6, 'focus' => 'Research'],
                'synthesis' => ['duration_weeks' => 4, 'focus' => 'Application']
            ]
        ];
    }
    ...
    private static function getSkillBasedTemplate(): array
    {
        return [
            'default_structure' => [
                'sections' => [
                    ['title' => 'Getting Started', 'lessons' => 2],
                    ['title' => 'Basic Techniques', 'lessons' => 4],
                    ['title' => 'Intermediate Skills', 'lessons' => 5],
                    ['title' => 'Advanced Techniques', 'lessons' => 5],
                    ['title' => 'Practice Projects', 'lessons' => 4],
                    ['title' => 'Mastery and Beyond', 'lessons' => 3]
                ]
            ],
            'suggested_questions' => [
            ...
            'learning_progression' => [
                'beginner' => ['duration_weeks' => 3, 'focus' => 'Basics'],
                'intermediate' => ['duration_weeks' => 5, 'focus' => 'Practice'],
                'advanced' => ['duration_weeks' => 4, 'focus' => 'Mastery']
            ]
        ];
    }
    ...
    private static function getCertificationTemplate(): array
    {
        return [
            'default_structure' => [
                'sections' => [
                    ['title' => 'Certification Overview', 'lessons' => 2],
                    ['title' => 'Domain 1 Concepts', 'lessons' => 5],
                    ['title' => 'Domain 2 Concepts', 'lessons' => 5],
                    ['title' => 'Domain 3 Concepts', 'lessons' => 5],
                    ['title' => 'Practice Exams', 'lessons' => 4],
                    ['title' => 'Exam Strategies', 'lessons' => 2]
                ]
            ],
            'suggested_questions' => [
            ...
            'learning_progression' => [
                'foundation' => ['duration_weeks' => 4, 'focus' => 'Core Knowledge'],
                'practice' => ['duration_weeks' => 4, 'focus' => 'Application'],
                'review' => ['duration_weeks' => 2, 'focus' => 'Exam Prep']
            ]
        ];
    }
