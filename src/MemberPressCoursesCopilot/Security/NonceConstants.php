...
class NonceConstants
{
     ...
     * @return bool True if valid, false if not (only when $die is false)
     */
     ...
     * @param bool $referer Whether to add the referer field (default: true)
     * @param bool $echo Whether to echo the field (default: true)
