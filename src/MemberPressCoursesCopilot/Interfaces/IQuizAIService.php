...
interface IQuizAIService {
     ...
     * 
     * @param int $lesson_id The lesson ID to generate quiz from
     ...
     * 
     * @param int $course_id The course ID to generate quiz from
     * @param array $options Quiz generation options
     * @return array Generated quiz data
     */
     ...
     * 
     * @param int $quiz_id The quiz ID to analyze
     ...
     * 
     * @param int $quiz_id The quiz to optimize
